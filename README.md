...
- [Changing the SignUpApp `<title>`](#changing-the-page-title)
...
- [Injecting Data from the Server into the SignUpApp](#injecting-data-from-the-server-into-the-page)
...
## Injecting Data from the Server into the SignUpApp
